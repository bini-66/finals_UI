    ...
    internal class customerController
    {
        ...
        public DataSet searchName(string name1, string name2 = null)
        {
            ...
            if (string.IsNullOrEmpty(name2))
            {
                ...
                sql = "SELECT * FROM customer WHERE firstName = @name OR lastName = @name";
            ...
            else
            {
                ...
                sql = "SELECT * FROM customer WHERE firstName = @name1 AND lastName = @name2";
                com = new MySqlCommand(sql, con.getConnection());
        ...
        public DataSet searchPlateNo(string plateNumber)
        {
            ...
            //command class
            string sql = "SELECT c.* FROM customer c JOIN vehicle v ON c.customerId = v.customerId " +
